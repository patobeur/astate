...
-  `index.php`: Le script principal qui gère les requêtes de l'extension. Il est responsable de l'authentification, du traitement des données et de la communication sécurisée (chiffrement/déchiffrement).
